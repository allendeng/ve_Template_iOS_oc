//
//  RangersAPMEventViewController.m
//  RangersAPM_iOS
//
...
@interface RangersAPMEventViewController ()<UITableViewDelegate, UITableViewDataSource>
...
@implementation RangersAPMEventViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    
    self.tableView = [[UITableView alloc] initWithFrame:self.view.bounds style:UITableViewStylePlain];
    [self.tableView registerClass:UITableViewCell.class forCellReuseIdentifier:@"RangersAPMEventCell"];
...
{
    UITableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"RangersAPMEventCell"];
    ...
    if (!_items) {
        ...
        void(^customEventBlock)(void) = ^{
            ...
            if (strongSelf) {
                ...
                UIAlertController *alert = [UIAlertController alertControllerWithTitle:@"自定义事件" message:@"⚠️只有在RangersAPM配置开启的事件才能成功记录" preferredStyle:UIAlertControllerStyleAlert];
        ...
        RangersAPMCellItem *customEventItem = [RangersAPMCellItem itemWithTitle:@"记录一条自定义事件" block:customEventBlock];
