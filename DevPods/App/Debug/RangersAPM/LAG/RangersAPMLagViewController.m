...
@interface RangersAPMLagViewController ()<UITableViewDelegate, UITableViewDataSource>
...
@implementation RangersAPMLagViewController
...
- (void)viewDidLoad {
    ...
    [self.tableView registerClass:UITableViewCell.class forCellReuseIdentifier:@"RangersAPMLagCell"];
...
{
    UITableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"RangersAPMLagCell"];
...
- (NSMutableArray *)items {
    if (!_items) {
        ...
        RangersAPMCellItem *userLagItem = [RangersAPMCellItem itemWithTitle:@"触发自定义时长卡顿" block:userLagBlock];
