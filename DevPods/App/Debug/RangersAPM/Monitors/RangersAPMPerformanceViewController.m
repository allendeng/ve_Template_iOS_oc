//
//  RangersAPMPerformanceViewController.m
//  RangersAPM_iOS
//
...
@interface RangersAPMPerformanceViewController ()<UITableViewDelegate, UITableViewDataSource>
...
@implementation RangersAPMPerformanceViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    
    self.tableView = [[UITableView alloc] initWithFrame:self.view.bounds style:UITableViewStylePlain];
    [self.tableView registerClass:UITableViewCell.class forCellReuseIdentifier:@"RangersAPMPerformanceCell"];
...
{
    UITableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"RangersAPMPerformanceCell"];
...
- (NSMutableArray *)items
{
    if (!_items) {
        ...
        RangersAPMCellItem *startItem = [RangersAPMCellItem itemWithTitle:@"启动分析" block:startBlock];
        ...
        RangersAPMCellItem *fpsItem = [RangersAPMCellItem itemWithTitle:@"流畅性和丢帧分析" block:fpsBlock];
